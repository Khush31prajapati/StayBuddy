        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                {/* Instagram */}
                <div className="relative group">
                  <Link href="#" className="flex items-center justify-center text-gray-600 hover:text-pink-600 transition-all duration-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* LinkedIn */}
                <div className="relative group">
                  <Link href="#" className="flex items-center justify-center  text-gray-600 hover:text-blue-700 transition-all duration-200">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/properties?tab=pg&pgFor=Boys" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                  {t.discover.links[1]}
                </Link>
              </li>
              <li>
                <Link href="/properties?tab=pg&tenant=Students" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                  {t.discover.links[2]}
                </Link>
              </li>
              <li>
                <Link href="/properties?tab=tenant" className="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                  {t.discover.links[3]}
                </Link>
              </li>
              <li>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <div className="flex-1">
                  <Link href={`mailto:${t.contact.email}`} className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm">
                    {t.contact.email}
                  </Link>
                </div>
              </div>
              ...
              <div className="flex items-center gap-1.5">
                ...
                <div className="flex-1">
                  <Link href={`tel:${t.contact.phone}`} className="text-gray-600 hover:text-blue-600 transition-colors duration-200 text-sm">
                    {t.contact.phone}
                  </Link>
                </div>
              </div>
